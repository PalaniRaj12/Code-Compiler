...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav" style="float: right;">
    	<li><a href="userloginform.html">Log out</a></li>
    </ul>
  </div>
</nav>
<div  class="container">
...
<table style="color: #fff;">
	...
	<div style="float:left; height:100%; width:35%; margin-left:0px; margin-top: 0px;">
		<table>
			<tr>
				<th>
					<h6>Class name should be "Main"</h6>
				</th>
			</tr>
			<tr>
				<td>
					<form:textarea spellcheck="false" class="lined" cols="60" rows="15" path="code" cssStyle="overflow:hidden;" />
				</td>
			</tr>
			<tr>
			...
			<table>
				<tr style="font-family: cursive; float: left; margin-left: 0px; width: 500px;">
					<td style="float: left; margin-left: 30px;">
						<h6>File Input<form:checkbox path="checkbox" /></h6>
					</td> 
					<td style="float: left; margin-left: 300px; margin-top: 5px;">
						<input type="submit" name="Run" class="btn btn-primary btn-block btn-large" value="Run" />
					</td>
				</tr>
				<tr style="font-family: cursive;">		
					<td style="float: left; margin-left: 20px; margin-top: 0px;">
						<form:input id="file" path="file" type="file"  /></td>
	...
	<th valign="top">
		<div style="float:left; margin-left: 60px; height:100% width:35%; font-family: cursive;">
			<form:form commandName="adminForm">
				...
				<%=session.getAttribute("result"+session.getAttribute("qid")) %>
		</div>
	</th>
	</tr>
	</table>
