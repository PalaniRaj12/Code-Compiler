...
public class UserLoginController {
	...
	public String processForm(@Valid LoginForm loginForm, BindingResult result,Map<String, Object> model,HttpServletRequest request)
	{
		...
		Transaction transaction = session1.beginTransaction();
		 Query query = session1.createQuery("SELECT registration.password FROM Registration registration WHERE registration.email = :email ");
		...
		compilationForm.setQuestionId(1);
